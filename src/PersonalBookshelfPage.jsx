  ...
  return (
    <div className="container mx-auto mt-10 px-4 lg:px-36">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link to="/" className="flex items-center px-4 py-3 pl-5 font-medium min-w-48 text-center bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors duration-300">
          Go Back to Home
        </Link>
      </div>
      {bookshelf.length === 0 ? (
          ...
          {bookshelf.map(book => (
            ...
            >
              <div className="p-4">
                ...
                <p className="text-red-500 italic mb-2">{book.author_name && book.author_name.join(", ")}</p>
                <div className="text-sm text-gray-500">
                  ...
                  <p className="font-medium">
                    Language: {book.language ? book.language.slice(0, 1) : "Unk"}
                  </p>
                  <p className="font-medium">
                    Rating: {book.ratings_average ? book.ratings_average.toFixed(1) : "Not Rated"}
                  </p>
                </div>
                <button
